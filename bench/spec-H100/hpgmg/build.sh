...
MPI_INCLUDE="-I/soft/compilers/nvhpc/Linux_x86_64/24.1/comm_libs/12.3/hpcx/hpcx-2.17.1/ompi/include"
./configure --CC=$CC --NVCC=$NVCC --CFLAGS="-O2 -fopenmp $OPTS" --NVCCFLAGS="-O2 -lineinfo -lnvToolsExt $MPI_INCLUDE $OPTS" --CUDAARCH="$CUDA_ARCH" --no-fe
