...
# Usage: CUDA_VISIBLE_DEVICES=0,1 ./conjugateGradientMultiDeviceCG.sh [NUM_GPUS]
...
BENCHMARK_BIN="${BENCHMARK_BUILD_ROOT}/conjugateGradientMultiDeviceCG/conjugateGradientMultiDeviceCG"
...
exec "${BENCHMARK_BIN}" --n="${PROBLEM_SIZE}" --max-iters="${MAX_ITERS}" "$@"
