...
if (( PROBLEM_SIZE % 2 != 0 )); then
    echo "Error: PROBLEM_SIZE must be divisible by 2 for simpleCUFFT_2d_MGPU." >&2
    exit 1
fi
...
BENCHMARK_BIN="${BENCHMARK_BUILD_ROOT}/simpleCUFFT_2d_MGPU/simpleCUFFT_2d_MGPU"
