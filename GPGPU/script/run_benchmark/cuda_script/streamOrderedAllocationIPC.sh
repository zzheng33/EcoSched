...
# Usage: CUDA_VISIBLE_DEVICES=0,1,2,3 ./streamOrderedAllocationIPC.sh [NUM_GPUS] [benchmark args...]
# Auto-detects all GPUs with memory pool IPC support, spawns one child process per GPU.
...
BENCHMARK_BUILD_ROOT="${BENCHMARK_BUILD_ROOT:-$SCRIPT_DIR/../build-sm80}"
BENCHMARK_BIN="${BENCHMARK_BUILD_ROOT}/streamOrderedAllocationIPC/streamOrderedAllocationIPC"
