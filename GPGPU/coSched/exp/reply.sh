...
# time CUDA_VISIBLE_DEVICES=3 numactl --cpunodebind=1 --membind=1 bash ~/power/GPGPU/script/run_benchmark/cuda_script/MonteCarloMultiGPU.sh 1
...
# time CUDA_VISIBLE_DEVICES=0,1,2 numactl --cpunodebind=0 --membind=0 bash ~/power/GPGPU/script/run_benchmark/spec_script/pot3d.sh 3
